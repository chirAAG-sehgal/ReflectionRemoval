...
if __name__ == "__main__":
    ...
    parser.add_argument("--vq-ckpt", type=str, default="/home/uas-dtu/Documents/chirag/LowLIGHTQuantGAN/checkpoints-300/0000900.pt", help="Checkpoint path for vq model")
